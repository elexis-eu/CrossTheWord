 ...
 * Classe che gestisce tutti i bottoni del Menu.
 */
public class MenuButton extends ImageButton
{
     ...
     */
    public MenuButton(ClickListener event, Stage stage, Texture imageUp)
    {
     ...
     */
    public MenuButton(Stage stage,Texture imageUp)
    {
